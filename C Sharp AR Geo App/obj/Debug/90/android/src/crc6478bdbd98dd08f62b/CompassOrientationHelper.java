package crc6478bdbd98dd08f62b;


public class CompassOrientationHelper
...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Esri.ArcGISRuntime.ARToolkit.CompassOrientationHelper, Esri.ArcGISRuntime.ARToolkit", CompassOrientationHelper.class, __md_methods);
	}


	public CompassOrientationHelper ()
	{
		super ();
		if (getClass () == CompassOrientationHelper.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.ARToolkit.CompassOrientationHelper, Esri.ArcGISRuntime.ARToolkit", "", this, new java.lang.Object[] {  });
	}

	public CompassOrientationHelper (android.content.Context p0)
	{
		super ();
		if (getClass () == CompassOrientationHelper.class)
			mono.android.TypeManager.Activate ("Esri.ArcGISRuntime.ARToolkit.CompassOrientationHelper, Esri.ArcGISRuntime.ARToolkit", "Android.Content.Context, Mono.Android", this, new java.lang.Object[] { p0 });
	}
